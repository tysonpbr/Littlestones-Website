...
import { homepage1, about1, about2, downArrow } from '../assets';

const Home = () => {
  return (
    <div className="">
      <div className="h-screen w-full overflow-hidden flex justify-center place-items-center lg:mb-8">
        <img src={homepage1} className="blur-sm lg:blur w-auto h-screen lg:h-auto max-w-none lg:min-w-home min-h-home pt-topsmHome md:pt-topmdHome lg:pt-topHome" />
        ...
        <a href="#scroll" className='absolute max-w-lg pt-64 lg:pt-96 flex flex-col justify-center place-items-center'>
      ...
      <div>
        ...
        <div className="pt-16 pb-8">
          <div className="bg-cyan-100 flex justify-center place-items-center">
            <p className='py-16 px-8 md:px-24 lg:px-64 text-4xl md:text-6xl lg:text-7xl'>Do I need to be liked? Absolutely not. I like to be liked. I enjoy being liked. I have to be liked. But it’s not like this compulsive need like my need to be praised.</p>
          </div>
        </div>
